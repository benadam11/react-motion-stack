  ...
  _createClass(MotionStack, [{
    ...
    value: function render() {
      ...
      return React.createElement(Fragment, null, React.createElement("div", {
        ...
        return i < renderCount && React.createElement(reactMotion.Motion, {
          key: id,
...
var _initialiseProps = function _initialiseProps() {
  ...
  Object.defineProperty(this, "getStyle", {
    ...
    value: function value(id, i) {
      ...
      var next = {
        scale: reactMotion.spring(isSecond, springConfig),
        shadow: reactMotion.spring(0, springConfig),
        rotate: reactMotion.spring(0, springConfig),
        opacity: reactMotion.spring(nextOpacity, springConfig),
        x: reactMotion.spring(0, springConfig)
      };
      ...
      var pan = {
        scale: reactMotion.spring(1.1, springConfig),
        shadow: reactMotion.spring(16, springConfig),
        opacity: reactMotion.spring(clamp(1 / (Math.abs(mouseX) / 100) + 0.5, 0, 1), springConfig),
        rotate: clamp(mouseX / 15, -45, 45),
        x: mouseX
      };
      var finish = _extends({}, pan, {
        rotate: reactMotion.spring(direction === 'left' ? -45 : 45, springConfig),
        opacity: reactMotion.spring(0, springConfig),
        x: reactMotion.spring(direction === 'left' ? -360 : 360, springConfig)
      });
